...
function T(e, t, o=!1) {
    ...
    return (i && !o ? t.contains(f) : t === f && 'BODY' !== f.nodeName) && (u = y(u, t)),
    u
}
function D(e, t=!1) {
    var o = Math.max;
...
function C(e) {
    const t = e.nodeName;
    return 'BODY' === t || 'HTML' === t ? !1 : !('fixed' !== s(e, 'position')) || C(f(e))
}
function N(e) {
    if (!e || !e.parentElement || h())
        return document.documentElement;
    let t = e.parentElement;
    for (; t && 'none' === s(t, 'transform'); )
        t = t.parentElement;
...
function P(e, t, o, n, i=!1) {
    ...
    if ('viewport' === n)
        ...
        let o;
        'scrollParent' === n ? (o = a(f(t)),
        'BODY' === o.nodeName && (o = e.ownerDocument.documentElement)) : 'window' === n ? o = e.ownerDocument.documentElement : o = n;
        const d = T(o, p, i);
    ...
    return r.left += d ? o : o.left || 0,
    r.top += d ? o : o.top || 0,
    r.right -= d ? o : o.right || 0,
    r.bottom -= d ? o : o.bottom || 0,
    r
}
function H({width: e, height: t}) {
    return e * t
}
...
function R(e, t, o) {
    ...
    return n.forEach((e)=>{
        ...
        e.enabled && d(o) && (t.offsets.popper = L(t.offsets.popper),
...
function U() {
    ...
    e.offsets.reference = W(this.state, this.popper, this.reference, this.options.positionFixed),
...
function z(e, t, o, n) {
    o.updateBound = n,
    K(e).addEventListener('resize', o.updateBound, {
        passive: !0
    });
    const i = a(e);
    return q(i, 'scroll', o.updateBound, o.scrollParents),
    o.scrollElement = i,
    o.eventsEnabled = !0,
    o
}
...
function Q(e, t) {
    Object.keys(t).forEach((o)=>{
        let n = '';
        -1 !== ['width', 'height', 'top', 'right', 'bottom', 'left'].indexOf(o) && J(t[o]) && (n = 'px'),
        e.style[o] = t[o] + n
    }
    )
}
...
function ee(e, t, o, n, i) {
    const r = W(i, t, e, o.positionFixed)
      , p = B(o.placement, r, t, e, o.modifiers.flip.boundariesElement, o.modifiers.flip.padding);
...
function te(e, t) {
    var o = Math.round;
    const {popper: n, reference: i} = e.offsets
      , r = -1 !== ['left', 'right'].indexOf(e.placement)
      , p = -1 !== e.placement.indexOf('-')
      , d = i.width % 2 == n.width % 2
      , s = 1 == i.width % 2 && 1 == n.width % 2
      , f = (e)=>e
      , a = t ? r || p || d ? o : Math.floor : f
      , l = t ? o : f;
    return {
        left: a(s && !p && t ? n.left - 1 : n.left),
        top: l(n.top),
        bottom: l(n.bottom),
        right: a(n.right)
    }
...
function ne(e, t) {
    ...
    const p = void 0 === r ? t.gpuAcceleration : r
      ...
      , h = V('transform');
    let u, g;
    if (g = 'bottom' == l ? 'HTML' === d.nodeName ? -d.clientHeight + a.bottom : -s.height + a.bottom : a.top,
    u = 'right' == m ? 'HTML' === d.nodeName ? -d.clientWidth + a.right : -s.width + a.right : a.left,
    p && h)
    ...
    return e.attributes = O({}, b, e.attributes),
...
function re(e, t) {
    ...
    return w = Math.max(Math.min(i[d] - h, w), 0),
    e.arrowElement = o,
    e.offsets.arrow = {
        [a]: Math.round(w),
        [l]: ''
...
function le(e, t) {
    ...
    return p.forEach((d,s)=>{
        ...
        y && (r = pe(r)),
        e.placement = n + (r ? '-' + r : ''),
        e.offsets.popper = O({}, e.offsets.popper, M(e.instance.popper, e.offsets.reference, e.placement)),
...
function me(e) {
    const {popper: t, reference: o} = e.offsets
      ...
      , d = r ? 'left' : 'top'
      , s = r ? 'width' : 'height';
    return t[p] < i(o[d]) && (e.offsets.popper[d] = i(o[d]) - t[s]),
...
function he(e, t, o, n) {
    ...
    if ('vh' === d || 'vw' === d) {
        let e;
        return e = 'vh' === d ? i(document.documentElement.clientHeight, window.innerHeight || 0) : i(document.documentElement.clientWidth, window.innerWidth || 0),
        e / 100 * p
    }
    return p
}
...
function ue(e, {offset: t}) {
    const {placement: o, offsets: {popper: n, reference: i}} = e
      , r = o.split('-')[0];
    let p;
    return p = J(+t) ? [+t, 0] : ce(t, n, i, r),
    'left' === r ? (n.top += p[0],
    n.left -= p[1]) : 'right' === r ? (n.top += p[0],
    n.left += p[1]) : 'top' === r ? (n.left += p[0],
    n.top -= p[1]) : 'bottom' === r && (n.left += p[0],
    n.top += p[1]),
    e.popper = n,
    e
}
...
function ye(e) {
    ...
    return n[r ? 'left' : 'top'] = i[o] - (p ? n[r ? 'width' : 'height'] : 0),
    e.placement = A(t),
...
class ve {
    constructor(e, t, o={}) {
        ...
        this.modifiers = Object.keys(this.options.modifiers).map((e)=>O({
            name: e
        }, this.options.modifiers[e])).sort((e,t)=>e.order - t.order),
