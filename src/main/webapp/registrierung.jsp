        ...
        <div class="card-group mb-0">
          <div class="card p-4">
            <div class="card-body">
              ...
              <div class="input-group mb-4">
                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                <input type="password" class="form-control" name = "pBestaetigen" placeholder="Passwort bestätigen">
              </div>
              <div class="row">
                <div class="col-6">
                  <button type="submit" class="btn btn-secondary px-4">Registrieren</button>
                  
                </div>   
                <div>
                  <a href = "login.jsp">Account bereits vorhanden?</a>
                  </div>                         
              </div>
             </form>
            </div>            
